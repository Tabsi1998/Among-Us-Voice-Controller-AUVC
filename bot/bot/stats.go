...
func (bot *Bot) UserStatsEmbed(userID, guildID string, sett *settings.GuildSettings) *discordgo.MessageEmbed {
...
func (bot *Bot) GuildStatsEmbed(guildID string, sett *settings.GuildSettings) *discordgo.MessageEmbed {
	gname := ""
	avatarURL := ""
